...
<nav class="navbar navbar-expand-lg main-navbar">
  ...
  <ul class="navbar-nav navbar-right">    
    <!-- Dark Mode Toggle -->
    <li class="nav-item">
      <a href="javascript:void(0);" id="dark-mode-toggle" class="nav-link nav-link-lg">
    ...
    <li class="dropdown">
      ...
      <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg">
        <i class="fas fa-globe"></i> <span class="d-none d-md-inline"><?php echo $current_language; ?></span>
      </a>
      <div class="dropdown-menu dropdown-menu-right">
        <div class="dropdown-title"><?php echo $this->lang->line("Switch Language"); ?></div>
        <?php 
        foreach ($language_info as $key => $value) 
        {
          echo '<a href="" data-id="'.$key.'" class="dropdown-item language_switch">'.$value.'</a>';
        } 
        ?>
      </div>
    </li>
