...
<head>
	...
	<style type="text/css">
		...
		body.dark-mode .header_navbar {
			background-color: rgba(11, 15, 25, 0.9) !important;
			border-bottom: 1px solid #1f2937;
			backdrop-filter: blur(10px);
		}
		body.dark-mode .header_navbar .navbar .navbar-nav li a {
			color: #f3f4f6 !important;
		}
		body.dark-mode .header_navbar .navbar .navbar-nav li a.active, 
		body.dark-mode .header_navbar .navbar .navbar-nav li a:hover {
		...
		body.dark-mode .feature-area {
			background-color: #0b0f19 !important;
		}
		body.dark-mode .section-title h3 {
			color: #ffffff !important;
		}
		body.dark-mode .single-feature {
			background: #1f2937 !important;
			border: 1px solid #374151 !important;
		}
		body.dark-mode .single-feature .feature-content h4 {
			color: #ffffff !important;
		}
		body.dark-mode .single-feature .feature-content p {
			color: #9ca3af !important;
		}
		body.dark-mode .how-work-area {
			background-color: #0e1320 !important;
		}
		body.dark-mode .how-work-content-wrapper .section-title h3 {
			color: #ffffff !important;
		}
		body.dark-mode .how-work-content-wrapper .section-title p {
			color: #9ca3af !important;
		}
		body.dark-mode .accordion-style .single-accordion {
			background: #1f2937 !important;
			border: 1px solid #374151 !important;
		}
		body.dark-mode .accordion-style .single-accordion .accordion-btn button {
			color: #ffffff !important;
		}
		body.dark-mode .accordion-style .single-accordion .accordion-content {
		...
		body.dark-mode .video-area .section-title h3 {
			color: #ffffff !important;
		}
		body.dark-mode .card {
		...
		body.dark-mode .card .card-title a {
			color: #ffffff !important;
		}
		body.dark-mode .screenshot-area-wrapper, 
		body.dark-mode .screenshot-area {
			background-color: #0e1320 !important;
		}
		...
		body.dark-mode .single-testimonial path {
			fill: #1f2937 !important;
		}
		body.dark-mode .client-details h6 {
			color: #ffffff !important;
		}
		...
		body.dark-mode .single-price:hover, 
		body.dark-mode .single-price.active {
			background: #111827 !important;
			border-color: #3b82f6 !important;
		}
		body.dark-mode .single-price .package-name, 
		body.dark-mode .single-price .package-price {
			color: #ffffff !important;
		}
		body.dark-mode .single-price .package-details li {
			color: #9ca3af !important;
		}
		body.dark-mode .download-area {
			background-color: #0b0f19 !important;
		}
		...
		body.dark-mode .contact-form-wrapper h4 {
			color: #ffffff !important;
		}
...
<body>
								...
								<ul id="nav" class="navbar-nav ml-auto">
									...
									<li class="nav-item dropdown">
										...
										<a class="nav-link dropdown-toggle" href="#" id="langDropdown" role="button" data-toggle="dropdown" aria-expanded="false">
											<i class="lni lni-world"></i> <?php echo $current_language; ?>
										</a>
										<ul class="dropdown-menu dropdown-menu-right" aria-labelledby="langDropdown">
											<?php 
											foreach ($language_info as $key => $value) {
												echo '<li><a href="" data-id="'.$key.'" class="dropdown-item language_switch">'.$value.'</a></li>';
											} 
											?>
										</ul>
									</li>
									...
									<li class="nav-item">
										<button id="dark-mode-toggle" class="theme-mode-btn nav-link">
											<i class="lni lni-sun" id="dark-mode-icon"></i>
										</button>
									</li>
								</ul>
							</div> <!-- navbar collapse -->
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$(document).on('click', '.language_switch', function(e) {
				e.preventDefault();
			...
			if (currentTheme === 'dark') {
				...
				icon.removeClass('lni-sun').addClass('lni-night');
			} else {
				$('body').removeClass('dark-mode');
				icon.removeClass('lni-night').addClass('lni-sun');
			}
